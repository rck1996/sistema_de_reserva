...
<body class="min-h-screen text-slate-900">
    ...
    <main class="mx-auto grid max-w-7xl gap-6 px-4 py-6 sm:px-6 lg:grid-cols-[1.45fr_0.8fr] lg:px-8">
        <section class="rounded-[2rem] border border-white/50 bg-white/85 p-5 shadow-2xl backdrop-blur-xl sm:p-6">
            <div class="flex flex-col gap-3 border-b border-slate-200 pb-5 sm:flex-row sm:items-end sm:justify-between">
                <div>
                    ...
                    <h2 class="mt-2 text-2xl font-semibold">Revisa tu agenda y abre detalles con un clic</h2>
                </div>
        ...
        <aside class="space-y-6">
            ...
            <section class="rounded-[2rem] border border-white/50 bg-white/85 p-5 shadow-xl backdrop-blur-xl">
                <div class="text-xs font-semibold uppercase tracking-[0.3em] text-slate-500">Ayuda rápida</div>
                <div class="mt-3 space-y-3 text-sm leading-7 text-slate-600">
                    <p>Haz clic sobre una reserva para abrir sus detalles en modal.</p>
                    <p>Haz clic sobre el calendario para proponer fecha y hora en el formulario.</p>
                </div>
            </section>
        </aside>
    </main>

    <dialog id="booking-modal" class="w-[min(92vw,40rem)] rounded-[2rem] border-0 p-0">
