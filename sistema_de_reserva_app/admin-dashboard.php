...
<body class="min-h-screen text-slate-900">
    <header class="sticky top-0 z-40 border-b border-white/50 bg-white/75 backdrop-blur-xl">
        <div class="mx-auto flex max-w-7xl flex-col gap-4 px-4 py-4 sm:px-6 lg:flex-row lg:items-center lg:justify-between lg:px-8">
            ...
            <nav class="flex flex-wrap items-center gap-2 text-sm">
                ...
                <a href="#equipo" class="rounded-full border border-slate-200 bg-white px-4 py-2 text-slate-600 transition hover:border-slate-300">Equipo</a>
    ...
    <main class="mx-auto max-w-7xl space-y-6 px-4 py-6 sm:px-6 lg:px-8">
            ...
            <div class="rounded-[2rem] border border-white/50 bg-white/85 p-5 shadow-2xl backdrop-blur-xl sm:p-6">
                <div class="mb-5 flex flex-col gap-3 border-b border-slate-200 pb-5 sm:flex-row sm:items-end sm:justify-between">
                    <div>
                        ...
                        <h2 class="mt-2 text-2xl font-semibold">Agenda central con detalle en modal</h2>
                    </div>
                    <div class="text-sm text-slate-500">Revisa reservas, estado, servicio y cliente desde el calendario.</div>
                </div>
        ...
        <section class="grid gap-6 xl:grid-cols-2">
            <section id="equipo" class="rounded-[2rem] border border-white/50 bg-white/85 p-5 shadow-xl backdrop-blur-xl">
                <div class="flex items-center justify-between gap-4">
                    ...
                    <span class="rounded-full border border-slate-200 bg-slate-50 px-4 py-2 text-sm text-slate-500"><?php echo count($profesionales); ?> activos</span>
                </div>
                ...
                <div class="mt-6 space-y-3">
                    <?php foreach (array_slice($profesionales, 0, 5) as $profesional): ?>
