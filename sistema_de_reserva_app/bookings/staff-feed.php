...
$pdo = app_pdo();
$stmt = $pdo->prepare(
    'SELECT eventos.id_evento, eventos.title, eventos.start, eventos.end, eventos.estado_reserva, eventos.notas_reserva,
            clientes.nombre_cliente, clientes.apellido_cliente, clientes.telefono_cliente,
...
echo json_encode(fetch_all($stmt, array(':id_professional' => request_session_int('id_professional'))));
